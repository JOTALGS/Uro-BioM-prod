    ...
    useEffect(() => {
      Animated.parallel([ // Use parallel animation for simultaneous movement
        Animated.timing(translateY1, {
          toValue: 20, // Animate to the center (adjust offset for precise centering)
        ...
        Animated.timing(translateY3, {
          toValue: -220, // Animate to the center (adjust offset for precise centering)
          duration: 300, // Animation duration (adjust as desired)
          useNativeDriver: true, // Optimize performance (optional)
        }),
      ]).start();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        ...
        <Animated.View  style={{ transform: [{ translateY: translateY1 }] }}>
          ...
          <Text style={styles.buttonText}>Previo a <Text style={{ textDecorationLine: 'underline' }}>decidir</Text> tratamiento en Ca Prostáta bajo riesgo</Text>
          </TouchableOpacity>
        </Animated.View>
        <Animated.View  style={{ transform: [{ translateY: translateY2 }] }}>
          ...
          <Text style={styles.buttonText}>Previo a <Text style={{ textDecorationLine: 'underline' }}>decidir</Text> tratamiento en Ca Prostáta localizado</Text>
          </TouchableOpacity>
        </Animated.View >
        <Animated.View  style={{ transform: [{ translateY: translateY3 }] }}>
          ...
          style={styles.buttonInit}
          onPress={() => navigation.navigate('SearchResult', { protatect: true })}>
          <Text style={styles.buttonText}>Posterior a la prostatectomia radical para <Text style={{ textDecorationLine: 'underline' }}>decidir</Text> radioterapia adyuvante</Text>
          </TouchableOpacity>
        </Animated.View >
      </View>
    </View>
